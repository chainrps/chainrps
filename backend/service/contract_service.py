...
from backend.config import CONTRACT_ADDRESS, RPC_URL
...
class ContractService:
    ...
    def _load_contract_from_db(self) -> Optional[str]:
        ...
        try:
            from backend.repository import list_contracts
    ...
    async def _on_game_created(self, event_data: dict):
        ...
        """
        from backend.repository import update_game_from_chain_event
    ...
    async def _on_commit_submitted(self, event_data: dict):
        ...
        当玩家提交哈希承诺时，更新本地对局记录。
        """
        from backend.repository import get_game_by_chain_id, update_game_record
    ...
    async def _on_game_settled(self, event_data: dict):
        ...
        3. 通知双方 game_result
        """
        from backend.service.game_service import game_manager
        from backend.repository import get_game_by_chain_id
