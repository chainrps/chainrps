...
from backend.config import HOST, PORT, WS_HEARTBEAT_INTERVAL
from backend.api.routes import router
from backend.websocket import ws_manager, websocket_endpoint, heartbeat_loop
from backend.websocket.heartbeat import check_connections
from backend.repository import init_database
from backend.utils.redis_client import redis_client
from backend.service import contract_service
